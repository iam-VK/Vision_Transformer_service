...
def img_classification_model(keyframes_dir:str,vid_file_name:str):
    ...
    model_prediction = []
    key_frames_list = imgPath_To_List(keyframes_dir)
    ...
    json_parser(model_prediction,src_file=vid_file_name,output_file_name="keyframes_classified")
